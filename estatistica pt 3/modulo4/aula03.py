...
print(f'{model_1.predict(entrada)[0]:.2f} Litros ')
...
model_1.intercept_ #consumo independente das outras variáveis
...
pd.DataFrame([EQM_2, REQM_2, R2_2], ['EQM', 'REQM', 'R²'], columns = ['Comparação entre métricas para temperatura média'])
...
pd.DataFrame([EQM, REQM, R2], ['EQM', 'REQM', 'R²'], columns = ['Comparação entre métricas para temperatura máxima'])
